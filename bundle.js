...
/***/ function(module, exports, __webpack_require__) {
	...
	var hueOne = randomHue();
	var saturationOne = randomPercent();
	var luminanceOne = randomPercent();

	var hueTwo = randomHue();
	var saturationTwo = randomPercent();
	var luminanceTwo = randomPercent();

	var hueThree = getRandomInt(0, 360);
	var saturationThree = randomPercent();
	var luminanceThree = randomPercent();

	var hueFour = getRandomInt(0, 360);
	var saturationFour = randomPercent();
	var luminanceFour = randomPercent();

	var hueFive = randomHue();
	var saturationFive = randomPercent();
	var luminanceFive = randomPercent();

	var hslOne = "hsl(" + hueOne + ", " + saturationOne + "%, " + luminanceOne + "%)";
	var hslTwo = "hsl(" + hueTwo + ", " + saturationTwo + "%, " + luminanceTwo + "%)";
	var hslThree = "hsl(" + hueThree + ", " + saturationThree + "%, " + luminanceThree + "%)";
	var hslFour = "hsl(" + hueFour + ", " + saturationFour + "%, " + luminanceFour + "%)";
	var hslFive = "hsl(" + hueFive + ", " + saturationFive + "%, " + luminanceFive + "%)";
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.changePassword(data, app).done(ui.changePasswordSuccess).fail(ui.failure);
	};
	...
	var showSignUpModal = function showPasswordModal() {
	  $('#sign-up-modal').modal('show');
	};

	var showSignInModal = function showPasswordModal() {
	  $('#sign-in-modal').modal('show');
	};

	var showChangePasswordModal = function showPasswordModal() {
	...
	var onGetPalettes = function onGetPalettes(event) {
	  $('.palette-picker').hide();
	  $('.content').show();
	  event.preventDefault();
	  api.getPalettes().done(function (palettes) {
	    ui.displayPalettes(palettes);
	  }).fail(ui.failure);
	};

	var onGetUserPalettes = function onGetUserPalettes(event) {
	  $('.palette-picker').hide();
	  $('.content').show();
	  event.preventDefault();
	  api.getUserPalettes().done(function (palettes) {
	    ui.displayUserPalettes(palettes);
	  }).fail(ui.failure);
	};

	var onGetPalette = function onGetPalette(event) {
	  event.preventDefault();
	  api.getPalette().done(ui.success).fail(ui.failure);
	};

	var onCreatePalette = function onCreatePalette(event) {
	  var paletteName = $('#palette-name').val();

	  event.preventDefault();
	  api.createPalette(paletteName, hslOne, hslTwo, hslThree, hslFour, hslFive).done(ui.success).fail(ui.failure);
	};

	var onUpdatePalette = function onUpdatePalette(event) {
	  var paletteIdUpdate = $('#palette-id-update').val();
	  var paletteName = $('#palette-name').val();
	  console.log(paletteIdUpdate);

	  event.preventDefault();
	  api.updatePalette(paletteIdUpdate, paletteName, hslOne, hslTwo, hslThree, hslFour, hslFive).done(ui.success).fail(ui.failure);
	};

	var onDeletePalette = function onDeletePalette(event) {
	  var paletteIdDelete = $('#palette-id-delete').val();

	  event.preventDefault();
	  api.deletePalette(paletteIdDelete).done(ui.success).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getUserPalettes = function getUserPalettes() {
	  return $.ajax({
	...
	var createPalette = function createPalette(paletteName, hslOne, hslTwo, hslThree, hslFour, hslFive) {
	  return $.ajax({
	    url: app.api + '/palettes',
	    headers: {
	      Authorization: 'Token token=' + app.user.token
	...
	var updatePalette = function updatePalette(paletteIdPatch, paletteName, hslOne, hslTwo, hslThree, hslFour, hslFive) {
	  return $.ajax({
	...
	var deletePalette = function deletePalette(paletteIdDelete) {
	  return $.ajax({
...
/***/ function(module, exports) {
	...
	var app = {
	  api: 'https://color-palette-picker.herokuapp.com/'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayPalettes = function displayPalettes(data) {
	  var paletteListingTemplate = __webpack_require__(8);
	  $('.content').html(paletteListingTemplate({
	    palettes: data.palettes
	  }));
	};

	var displayUserPalettes = function displayUserPalettes(data) {
	  var paletteListingTemplate = __webpack_require__(28);
	  $('.content').html(paletteListingTemplate({
	    palettes: data.palettes
	  }));
	};
	...
	module.exports = {
	  ...
	  displayPalettes: displayPalettes,
	  displayUserPalettes: displayUserPalettes
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"palette-card\">\n  <div class=\"palette-thumbnail\">\n    <p class=\"thumbnail-color\" style=\"background-color: "
	    ...
	    + alias4(((helper = (helper = helpers.color1 || (depth0 != null ? depth0.color1 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color1","hash":{},"data":data}) : helper)))
	    + "\n    </p>\n    <p class=\"thumbnail-color\" style=\"background-color: "
	    + alias4(((helper = (helper = helpers.color2 || (depth0 != null ? depth0.color2 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color2","hash":{},"data":data}) : helper)))
	    + ";\">\n      "
	    + alias4(((helper = (helper = helpers.color2 || (depth0 != null ? depth0.color2 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color2","hash":{},"data":data}) : helper)))
	    + "\n    </p>\n    <p class=\"thumbnail-color\" style=\"background-color: "
	    + alias4(((helper = (helper = helpers.color3 || (depth0 != null ? depth0.color3 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color3","hash":{},"data":data}) : helper)))
	    + ";\">\n      "
	    + alias4(((helper = (helper = helpers.color3 || (depth0 != null ? depth0.color3 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color3","hash":{},"data":data}) : helper)))
	    + "\n    </p>\n    <p class=\"thumbnail-color\" style=\"background-color: "
	    + alias4(((helper = (helper = helpers.color4 || (depth0 != null ? depth0.color4 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color4","hash":{},"data":data}) : helper)))
	    + ";\">\n      "
	    + alias4(((helper = (helper = helpers.color4 || (depth0 != null ? depth0.color4 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color4","hash":{},"data":data}) : helper)))
	    + "\n    </p>\n    <p class=\"thumbnail-color\" style=\"background-color: "
	    + alias4(((helper = (helper = helpers.color5 || (depth0 != null ? depth0.color5 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color5","hash":{},"data":data}) : helper)))
	    + ";\">\n      "
	    + alias4(((helper = (helper = helpers.color5 || (depth0 != null ? depth0.color5 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"color5","hash":{},"data":data}) : helper)))
	    + "\n    </p>\n  </div>\n  <div class=\"palette-description\">\n    <h4 class=\"palette-name\">"
	    + alias4(((helper = (helper = helpers.palette_name || (depth0 != null ? depth0.palette_name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"palette_name","hash":{},"data":data}) : helper)))
	  ...
	  return "<h1>Inspiration</h1>\n<h3>All palettes by everyone</h3>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.palettes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
